...
Generate.prototype.generateManager = function() {
    ...
    <div class="card">
        ...
        <p>Email: <a class="link" href="mailto:${this.manager.getEmail()}">${this.manager.getEmail()}</a></p>
        ...
        ${this.engineer.map(eng => {
            return `
                <div class="card">
                    ...
                    <h3>${eng.getRole()}</h3>
                    <p>ID: ${eng.getId()}</p>
                    <p>Email: <a class="link" href="mailto:${eng.getEmail()}">${eng.getEmail()}</a></p>
                    <p>GitHub: <a class="link" href="https://github.com/${eng.getGithub()}">${eng.getGithub()}</a></p>
                </div>
            `
        })}
    `
        ...
        ${this.intern.map(int => {
            return `
                <div class="card">
                    ...
                    <h3>${int.getRole()}</h3>
                    <p>ID: ${int.getId()}</p>
                    <p>Email: <a class="link" href="mailto:${int.getEmail()}">${int.getEmail()}</a></p>
